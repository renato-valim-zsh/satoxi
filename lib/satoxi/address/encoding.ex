defprotocol Satoxi.Address.Encoding do
  ...
  Each address type (Legacy, P2SH, SegWit, etc.) implements this protocol
  to provide consistent encoding behavior.
  """

  @doc """
  Encodes the address struct to its string representation.

  Returns the address as a Base58Check or Bech32 encoded string,
