defmodule Satoxi.Encoding.VarInt do
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.decode(<<253, 4, 1>>)
      {:ok, 260}

      iex> Satoxi.Encoding.VarInt.decode(<<254, 0, 225, 245, 5>>)
      {:ok, 100_000_000}
  """
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.decode_binary(<<5, 104, 101, 108, 108, 111, 99, 99>>)
      {:ok, "hello"}
  """
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.encode(260)
      <<253, 4, 1>>

      iex> Satoxi.Encoding.VarInt.encode(100_000_000)
      <<254, 0, 225, 245, 5>>
  """
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.encode_binary("hello")
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.parse_data(<<5, 104, 101, 108, 108, 111, 1, 2, 3>>)
      {:ok, "hello", <<1, 2, 3>>}
  """
  ...
  ## Examples
      ...
      iex> Satoxi.Encoding.VarInt.parse_int(<<5, 104, 101, 108, 108, 111, 1, 2, 3>>)
