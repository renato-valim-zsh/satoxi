defmodule Satoxi.Script.OpCode do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Satoxi.Script.OpCode.to_atom :OP_RETURN
      :OP_RETURN

      iex> Satoxi.Script.OpCode.to_atom "op_return"
      :OP_RETURN

      iex> Satoxi.Script.OpCode.to_atom <<106>>
      :OP_RETURN

      iex> Satoxi.Script.OpCode.to_atom 106
      :OP_RETURN

      iex> Satoxi.Script.OpCode.to_atom :UNKNOWN_CODE
      nil
  """
  ...
  def to_atom!(op) do
    case to_atom(op) do
      nil -> raise Satoxi.Error, {:invalid_opcode, op}
      opcode -> opcode
    end
  end
  ...
  ## Examples
      ...
      iex> Satoxi.Script.OpCode.to_integer :OP_RETURN
      106

      iex> Satoxi.Script.OpCode.to_integer "op_return"
      106

      iex> Satoxi.Script.OpCode.to_integer <<106>>
      106

      iex> Satoxi.Script.OpCode.to_integer 106
      106

      iex> Satoxi.Script.OpCode.to_integer :UNKNOWN_CODE
      nil
  """
