defmodule Satoxi.Keys.ExtKey do
  ...
  * `:encoding` - Optionally decode the binary with either the `:base64` or `:hex` encoding scheme.
  ...
  ## Examples
      ...
      iex> Satoxi.Keys.ExtKey.from_string("xprv9s21ZrQH143K3qcbMJpvTQQQ1zRCPaZjXUD1zPouMDtKY9QQQ9DskzrZ3Cx38GnYXpgY2awCmJfz2QXkpxLN3Pp2PmUddbnrXziFtArpZ5v")
      {:ok, %Satoxi.Keys.ExtKey{
      ...
      iex> Satoxi.Keys.ExtKey.from_string("xpub661MyMwAqRbcGKh4TLMvpYM8a2Fgo3Hath8cnnDWuZRJQwjYwgY8JoB2tTgiTDdwf4rdGvgUpGhGNH54Ycb8vegrhHVVpdfYCdBBii94CLF")
      {:ok, %Satoxi.Keys.ExtKey{
        chain_code: <<178, 208, 232, 46, 183, 65, 27, 66, 14, 172, 46, 66, 222, 84, 220, 98, 70, 249, 25, 3, 50, 209, 218, 236, 96, 142, 211, 79, 59, 166, 41, 106>>,
        child_index: 0,
        depth: 0,
  ...
  def to_public(%__MODULE__{} = extkey) do
    version = @pubkey_version_bytes[Satoxi.network()]
  ...
  def to_string(%__MODULE__{privkey: %PrivKey{}} = extkey) do
    <<version_byte, version::binary>> = @privkey_version_bytes[Satoxi.network()]
  ...
  def to_string(%__MODULE__{privkey: nil, pubkey: %PubKey{}} = extkey) do
    <<version_byte, version::binary>> = @pubkey_version_bytes[Satoxi.network()]
  ...
  ## Example
      ...
      iex> Satoxi.Keys.ExtKey.derive(@extkey, "m/44'/0'/0'/0/99")
      %Satoxi.Keys.ExtKey{
