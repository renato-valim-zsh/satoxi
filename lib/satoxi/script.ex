defmodule Satoxi.Script do
  ...
  @doc """
  Parses the given ASM encoded string into a `t:Satoxi.Script.t/0`.
  ...
  @doc """
  Parses the given binary into a `t:Satoxi.Script.t/0`.
  ...
  * `:encoding` - Optionally decode the binary with either the `:base64` or `:hex` encoding scheme.
  ...
  @doc """
  Serialises the given `t:Satoxi.Script.t/0` into an ASM encoded string.
  ...
  @doc """
  Serialises the given `t:Satoxi.Script.t/0` into a binary.
