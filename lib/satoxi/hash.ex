defmodule Satoxi.Hash do
  @moduledoc """
  A collection of one-way hashing functions used frequently throughout Bitcoin.

  All hashing functions accept the `:encoding` option which can be `:base64` or `:hex`. 
  When omitted, the raw binary hash is returned.
  """
  import Satoxi.Encoding, only: [encode: 2]
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.ripemd160("hello world")
      <<152, 198, 21, 120, 76, 203, 95, 229, 147, 111, 188, 12, 190, 157, 253, 180, 8, 217, 47, 15>>

      iex> Satoxi.Hash.ripemd160("hello world", encoding: :hex)
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.sha1("hello world")
      <<42, 174, 108, 53, 201, 79, 207, 180, 21, 219, 233, 95, 64, 139, 156, 233, 30, 232, 70, 237>>

      iex> Satoxi.Hash.sha1("hello world", encoding: :hex)
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.sha1_hmac("hello world", "test")
      <<90, 9, 227, 4, 243, 198, 13, 99, 63, 241, 103, 53, 236, 147, 30, 17, 22, 255, 33, 209>>

      iex> Satoxi.Hash.sha1_hmac("hello world", "test", encoding: :hex)
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.sha256_ripemd160("hello world")
      <<215, 213, 238, 120, 36, 255, 147, 249, 76, 48, 85, 175, 147, 130, 200, 108, 104, 181, 202, 146>>

      iex> Satoxi.Hash.sha256_ripemd160("hello world", encoding: :hex)
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.sha512("hello world")
      <<48, 158, 204, 72, 156, 18, 214, 235, 76, 196, 15, 80, 201, 2, 242, 180, 208, 237, 119, 238, 81, 26, 124, 122, 155, 205, 60, 168, 109, 76, 216, 111, 152, 157, 211, 91, 197, 255, 73, 150, 112, 218, 52, 37, 91, 69, 176, 207, 216, 48, 232, 31, 96, 93, 207, 125, 197, 84, 46, 147, 174, 156, 215, 111>>

      iex> Satoxi.Hash.sha512("hello world", encoding: :hex)
      "309ecc489c12d6eb4cc40f50c902f2b4d0ed77ee511a7c7a9bcd3ca86d4cd86f989dd35bc5ff499670da34255b45b0cfd830e81f605dcf7dc5542e93ae9cd76f"

      iex> Satoxi.Hash.sha512("hello world", encoding: :base64)
  ...
  ## Examples
      ...
      iex> Satoxi.Hash.sha512_hmac("hello world", "test", encoding: :hex)
      ...
      iex> Satoxi.Hash.sha512_hmac("hello world", "test", encoding: :base64)
