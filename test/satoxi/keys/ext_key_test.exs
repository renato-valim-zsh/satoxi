defmodule Satoxi.Keys.ExtKeyTest do
  ...
  describe "ExtKey.from_seed/2" do
    ...
    test "returns error if seed is too small or too big" do
      assert {:error, _error} = :crypto.strong_rand_bytes(15) |> ExtKey.from_seed()
      assert {:error, _error} = :crypto.strong_rand_bytes(65) |> ExtKey.from_seed()
    end
  end
  ...
  describe "ExtKey.from_seed!/2" do
    ...
    test "raises error if seed is too small or too big" do
      assert_raise Satoxi.Error, ~r/invalid seed length/i, fn ->
        :crypto.strong_rand_bytes(15) |> ExtKey.from_seed!()
      end

      assert_raise Satoxi.Error, ~r/invalid seed length/i, fn ->
        :crypto.strong_rand_bytes(65) |> ExtKey.from_seed!()
      end
    end
  end
  ...
  describe "ExtKey.from_string!/1" do
    ...
    test "raises error with invalid xprv or xpub" do
      assert_raise Satoxi.Error, ~r/invalid xprv/i, fn ->
        ExtKey.from_string!("xprvNotAnXprv")
      end

      assert_raise Satoxi.Error, ~r/invalid xpub/i, fn ->
